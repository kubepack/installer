...
func (in *KubepackOperatorList) DeepCopyInto(out *KubepackOperatorList) {
	*out = *in
	...
	if in.Items != nil {
		...
		*out = make([]KubepackOperator, len(*in))
		for i := range *in {
...
func (in *KubepackOperatorList) DeepCopy() *KubepackOperatorList {
	if in == nil {
		return nil
	}
	out := new(KubepackOperatorList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KubepackOperatorSpec) DeepCopy() *KubepackOperatorSpec {
	if in == nil {
		return nil
	}
	out := new(KubepackOperatorSpec)
	in.DeepCopyInto(out)
	return out
}
