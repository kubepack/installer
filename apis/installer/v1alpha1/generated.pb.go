...
// source: go.kubepack.dev/installer/apis/installer/v1alpha1/generated.proto
...
func init() {
	proto.RegisterType((*GrafanaOperator)(nil), "go.kubepack.dev.installer.apis.installer.v1alpha1.GrafanaOperator")
	proto.RegisterType((*GrafanaOperatorList)(nil), "go.kubepack.dev.installer.apis.installer.v1alpha1.GrafanaOperatorList")
	proto.RegisterType((*GrafanaOperatorSpec)(nil), "go.kubepack.dev.installer.apis.installer.v1alpha1.GrafanaOperatorSpec")
	proto.RegisterMapType((map[string]string)(nil), "go.kubepack.dev.installer.apis.installer.v1alpha1.GrafanaOperatorSpec.AnnotationsEntry")
	proto.RegisterMapType((map[string]string)(nil), "go.kubepack.dev.installer.apis.installer.v1alpha1.GrafanaOperatorSpec.NodeSelectorEntry")
	proto.RegisterType((*HealthcheckSpec)(nil), "go.kubepack.dev.installer.apis.installer.v1alpha1.HealthcheckSpec")
	proto.RegisterType((*ImageRef)(nil), "go.kubepack.dev.installer.apis.installer.v1alpha1.ImageRef")
	proto.RegisterType((*Monitoring)(nil), "go.kubepack.dev.installer.apis.installer.v1alpha1.Monitoring")
	proto.RegisterType((*PrometheusSpec)(nil), "go.kubepack.dev.installer.apis.installer.v1alpha1.PrometheusSpec")
	proto.RegisterType((*ServiceAccountSpec)(nil), "go.kubepack.dev.installer.apis.installer.v1alpha1.ServiceAccountSpec")
	proto.RegisterType((*ServiceMonitorLabels)(nil), "go.kubepack.dev.installer.apis.installer.v1alpha1.ServiceMonitorLabels")
	proto.RegisterMapType((map[string]string)(nil), "go.kubepack.dev.installer.apis.installer.v1alpha1.ServiceMonitorLabels.LabelsEntry")
	proto.RegisterType((*ServingCerts)(nil), "go.kubepack.dev.installer.apis.installer.v1alpha1.ServingCerts")
	proto.RegisterType((*WebHookSpec)(nil), "go.kubepack.dev.installer.apis.installer.v1alpha1.WebHookSpec")
}

func init() {
	proto.RegisterFile("go.kubepack.dev/installer/apis/installer/v1alpha1/generated.proto", fileDescriptor_db9eaba34b53dd3f)
}
