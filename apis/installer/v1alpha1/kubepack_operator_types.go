...
// KubepackOperator defines the schama for KubeVault Operator Installer.
...
// +kubebuilder:resource:path=kubepackoperators,singular=kubepackoperator,categories={kubepack,appscode}
